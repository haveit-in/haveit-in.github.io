...
export function AdminLayout() {
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-slate-50 via-orange-50/30 to-slate-50">
      {/* Desktop Sidebar */}
      <aside className="hidden lg:flex lg:flex-col lg:w-64 lg:bg-white lg:border-r lg:border-slate-200 lg:shadow-sm">
        {/* Logo */}
        <div className="h-16 flex items-center px-6 border-b border-slate-200">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-semibold">
              <span className="text-orange-500">HaveIt Admin</span>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-40 flex">
          ...
          {/* Sidebar */}
          <aside className="relative flex flex-col w-72 bg-white shadow-xl">
            {/* Header */}
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* Desktop Header */}
        <header className="hidden lg:flex h-16 bg-white border-b border-slate-200 items-center justify-between px-6 shadow-sm">
          {/* Search Bar */}
        ...
        {/* Bottom Navigation - Mobile Only - REMOVED */}
